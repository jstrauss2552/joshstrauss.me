...
- Responsive single-column layouts on mobile; visible keyboard focus, a skip
  ...
  a continuous blue curve winds across the homepage as you scroll, with uneven
  sweeps and smaller bends along separate desktop and mobile routes. A natural
  cubic spline keeps it smooth, with eased drawing after each scroll gesture.
  Text and controls sit above the line; no cutout masks erase it at
